...
<div>
    ...
    <div class="relative">
        ...
        <button type="button" class="absolute top-0 end-0 p-1 min-[380px]:p-2 rounded-e-md" title="Afficher le mot de passe" onclick="showPassword()">
            ...
            <!-- Icône eye ouvert -->
            <svg @if ($confirmation == "true") id="svgEyeOpen2" @else id="svgEyeOpen1" @endif class="hidden colorFont fontSizeIcons" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
